...
psql -v ON_ERROR_STOP=1 --username "$POSTGRES_USER" <<-EOSQL
    ...
    CREATE TABLE assets (
      ...
      data_quote_start TIMESTAMP NOT NULL,
      data_quote_end TIMESTAMP NOT NULL,
      data_orderbook_start TIMESTAMP NOT NULL,
      data_orderbook_end TIMESTAMP NOT NULL,
      data_trade_start TIMESTAMP NOT NULL,
      data_trade_end TIMESTAMP NOT NULL,
      data_symbols_count INT NOT NULL,
      volume_1hrs_usd NUMERIC(20, 8) NOT NULL,
      volume_1day_usd NUMERIC(20, 8) NOT NULL,
      volume_1mth_usd NUMERIC(20, 8) NOT NULL,
      price_usd NUMERIC(20, 16) NOT NULL,
      id_icon VARCHAR(36) NOT NULL,
...
# add symbol foreign key to ohlcv
# we might get rid of volumes and dates
